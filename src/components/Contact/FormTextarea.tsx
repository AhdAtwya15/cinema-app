...
const FormTextarea = forwardRef<HTMLTextAreaElement, FormTextareaProps>(({ label, error, className, id, ...props }, ref) => {
    return (
        <div className="flex flex-col gap-1.5 w-full">
            ...
            <textarea
                ...
                id={id}
                className={`
                    w-full min-h-[120px] bg-[#1E223D] border border-slate-700/50 rounded-xl px-4 py-3
